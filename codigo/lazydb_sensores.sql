...
CREATE TABLE `sensores` (
  ...
  CONSTRAINT `sensores_ibfk_1` FOREIGN KEY (`id_equipamento`) REFERENCES `equipamentos` (`id_equipamento`)
...
INSERT INTO `sensores` VALUES (1,1,'Temperatura','°C'),(2,1,'Umidade','%'),(3,2,'Temperatura','°C'),(4,3,'Luminosidade','lux'),(5,4,'Pressao','hPa');
